...
alias french='~/dotfiles/contents/ai_tools.py vocab_easy -f French -b Indonesian'
alias turkish='~/dotfiles/contents/ai_tools.py vocab_easy -f Turkish -b Indonesian'
alias chinese='~/dotfiles/contents/ai_tools.py vocab_easy -f Chinese -b Indonesian'
